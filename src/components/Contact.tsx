export function Contact() {
  return (
    <section id="contact" className="px-6 pb-24 pt-14 sm:px-10 lg:px-16">
      <div className="mx-auto grid max-w-6xl gap-6 rounded-2xl border border-sky-700/15 bg-white/82 p-7 sm:p-9 lg:grid-cols-[1.25fr_1fr] dark:border-white/10 dark:bg-zinc-900/70">
        <div>
          <p className="text-xs uppercase tracking-[0.22em] text-sky-800/80 dark:text-sky-400/80">Contact</p>
        ...
        <div className="grid gap-3 self-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-xl border border-zinc-900/15 bg-white/70 px-4 py-3 text-center text-sm font-medium text-zinc-700 transition hover:bg-sky-50 dark:border-white/15 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
          >
            LinkedIn
          </a>
          <a
