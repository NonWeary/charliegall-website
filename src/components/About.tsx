  ...
  return (
    <section id="about" className="px-6 pb-24 pt-14 sm:px-10 lg:px-16">
      <div className="mx-auto max-w-6xl rounded-2xl border border-sky-700/15 bg-white/82 p-7 sm:p-9 dark:border-white/10 dark:bg-zinc-900/70">
        ...
        <div className="mt-8 rounded-xl border border-sky-700/15 bg-sky-50/45 p-5 sm:p-6 dark:border-sky-400/15 dark:bg-sky-900/15">
          <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Philosophy: Give. Grow. Deliver.</h3>
          ...
          <div className="mt-4 space-y-4 text-zinc-700 dark:text-zinc-300">
            <p>
              <span className="font-semibold text-zinc-900 dark:text-zinc-100">Give:</span> From Adam Grant, I&apos;ve been influenced by the idea of being a giver,
              helping others whenever you can, picking up the work people don&apos;t want to do, and doing what&apos;s best for the team at all
              times.
            </p>
            <p>
              <span className="font-semibold text-zinc-900 dark:text-zinc-100">Grow:</span> Also from Adam Grant, I&apos;ve adopted the idea that reward is in
              growing. Try to seek growth over other things.
            </p>
            <p>
              <span className="font-semibold text-zinc-900 dark:text-zinc-100">Deliver:</span> From John Doerr I learned about OKRs, and have adopted this method
